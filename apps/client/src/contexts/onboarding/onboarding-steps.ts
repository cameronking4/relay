...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "Let's take a quick tour to help you get started. Relay helps you run multiple AI coding agents in parallel to solve tasks faster.",
    placement: "center",
  },
  {
    id: "dashboard",
  ...
  },
  {
    ...
    description:
      "You now know the essentials of Relay. Start by selecting a repository and describing a task. The AI agents will handle the rest!",
    placement: "center",
  },
];
