...
<p align="center">
  <a href="https://www.manaflow.com/direct-download-macos">
    <img src="./docs/assets/macos-badge.png" alt="Download Relay for macOS" width="180" />
  </a>
</p>

<p align="center">
  Join the <a href="https://discord.gg/SDbQmzQhRK">Discord</a> to talk more about Relay!
</p>

Relay lets you spawn Claude Code, Codex CLI, Cursor CLI, Gemini CLI, Amp, Opencode, and other coding agent CLIs in parallel across multiple tasks.
...
<p>Review diffs, squash and merge, or open pull requests directly from the workspace. View GitHub Action results and CI status without leaving Relay.</p>
</td>
</tr>
</table>
...
Relay supports macOS. Linux in beta. Windows coming soon.
