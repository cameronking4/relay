 ...
 */
export const postApiTeamsByTeamSlugOrIdTaskInvocations = <ThrowOnError extends boolean = false>(options: Options<PostApiTeamsByTeamSlugOrIdTaskInvocationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTeamsByTeamSlugOrIdTaskInvocationsResponses, PostApiTeamsByTeamSlugOrIdTaskInvocationsErrors, ThrowOnError>({
 ...
 */
export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationId = <ThrowOnError extends boolean = false>(options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdResponses, GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdErrors, ThrowOnError>({
 ...
 */
export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWait = <ThrowOnError extends boolean = false>(options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitResponses, GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitErrors, ThrowOnError>({
 ...
 * List team API keys
 */
export const getApiTeamsByTeamSlugOrIdAuthTeamApiKeys = <ThrowOnError extends boolean = false>(options: Options<GetApiTeamsByTeamSlugOrIdAuthTeamApiKeysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiTeamsByTeamSlugOrIdAuthTeamApiKeysResponses, GetApiTeamsByTeamSlugOrIdAuthTeamApiKeysErrors, ThrowOnError>({
 ...
 */
export const postApiTeamsByTeamSlugOrIdAuthTeamApiKeys = <ThrowOnError extends boolean = false>(options: Options<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysResponses, PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysErrors, ThrowOnError>({
        url: '/api/teams/{teamSlugOrId}/auth/team-api-keys',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyId = <ThrowOnError extends boolean = false>(options: Options<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdResponses, DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdErrors, ThrowOnError>({
