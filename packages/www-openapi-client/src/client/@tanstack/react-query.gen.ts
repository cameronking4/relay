 ...
 */
export const postApiTeamsByTeamSlugOrIdTaskInvocationsMutation = (options?: Partial<Options<PostApiTeamsByTeamSlugOrIdTaskInvocationsData>>): UseMutationOptions<PostApiTeamsByTeamSlugOrIdTaskInvocationsResponse, PostApiTeamsByTeamSlugOrIdTaskInvocationsError, Options<PostApiTeamsByTeamSlugOrIdTaskInvocationsData>> => {
    const mutationOptions: UseMutationOptions<PostApiTeamsByTeamSlugOrIdTaskInvocationsResponse, PostApiTeamsByTeamSlugOrIdTaskInvocationsError, Options<PostApiTeamsByTeamSlugOrIdTaskInvocationsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiTeamsByTeamSlugOrIdTaskInvocations({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdQueryKey = (options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdData>) => createQueryKey('getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationId', options);

/**
 * Get task invocation status
 */
export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdOptions = (options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdQueryKey(options)
    });
};

export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitQueryKey = (options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitData>) => createQueryKey('getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWait', options);

/**
 * Wait for task invocation status
 */
export const getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitOptions = (options: Options<GetApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWait({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiTeamsByTeamSlugOrIdTaskInvocationsByInvocationIdWaitQueryKey(options)
    });
};

export const getApiTeamsByTeamSlugOrIdAuthTeamApiKeysQueryKey = (options: Options<GetApiTeamsByTeamSlugOrIdAuthTeamApiKeysData>) => createQueryKey('getApiTeamsByTeamSlugOrIdAuthTeamApiKeys', options);

/**
 * List team API keys
 */
export const getApiTeamsByTeamSlugOrIdAuthTeamApiKeysOptions = (options: Options<GetApiTeamsByTeamSlugOrIdAuthTeamApiKeysData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiTeamsByTeamSlugOrIdAuthTeamApiKeys({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiTeamsByTeamSlugOrIdAuthTeamApiKeysQueryKey(options)
    });
};
 ...
 */
export const postApiTeamsByTeamSlugOrIdAuthTeamApiKeysMutation = (options?: Partial<Options<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysData>>): UseMutationOptions<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysResponse, PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysError, Options<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysData>> => {
    const mutationOptions: UseMutationOptions<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysResponse, PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysError, Options<PostApiTeamsByTeamSlugOrIdAuthTeamApiKeysData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiTeamsByTeamSlugOrIdAuthTeamApiKeys({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const deleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdMutation = (options?: Partial<Options<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdData>>): UseMutationOptions<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdResponse, DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdError, Options<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdData>> => {
    const mutationOptions: UseMutationOptions<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdResponse, DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdError, Options<DeleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyIdData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteApiTeamsByTeamSlugOrIdAuthTeamApiKeysByKeyId({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
